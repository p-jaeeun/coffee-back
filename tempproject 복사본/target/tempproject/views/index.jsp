...
<head>
    ...
    <link rel="stylesheet" href="/hiddenc/resources/css/icons.css" />
    <link rel="stylesheet" href="/hiddenc/resources/css/animate.min.css" />
    ...
    <link rel="stylesheet" href="/hiddenc/resources/css/customize.css" />
    <title>Index</title>
</head>
...
<!-- Script -->
<script src="/hiddenc/resources/js/jquery.min.js" type="text/javascript"></script>
<script src="/hiddenc/resources/js/modernizr.js" type="text/javascript"></script>
<script src="/hiddenc/resources/js/script.js" type="text/javascript"></script>
<script src="/hiddenc/resources/js/bootstrap.min.js" type="text/javascript"></script>
<script src="/hiddenc/resourcesjs/wow.min.js" type="text/javascript"></script>
<script src="/hiddenc/resources/js/slick.min.js" type="text/javascript"></script>
<script src="/hiddenc/resources/js/sumoselect.js" type="text/javascript"></script>
<script src="/hiddenc/resources/js/isotop.js" type="text/javascript"></script>
<script src="/hiddenc/resources/js/jquery.nicescroll.min.js" type="text/javascript"></script>
<script type="text/javascript" src="/hiddenc/resources/js/map1.js"></script>
<script type="text/javascript" src="/hiddenc/resources/js/jq.aminoSlider.js"></script>
<!-- <script
  type="text/javascript"
  src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f6ac04217d0213217c7208829defdafb"
></script> -->
<!-- <script src="./index_bundle.js"></script> -->
<script src="/hiddenc/resources/app.js" type="module"></script>
</body>
</html>